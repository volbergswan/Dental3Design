// ============================================
// DATABASE TYPES - Dental3Design (Unified)
// Schema: Option B — Profiles direct (no labs dependency)
// ============================================
...
export type ProfileStatus = 'active' | 'warning' | 'deactivated';
export type CaseStatus = 'statusNone' | 'statusPending' | 'statusInProgress' | 'statusCompleted';
